    ...
    <div class="row">
        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          @foreach($data as $d)
            <ul class="nav">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-shopping-bag" aria-hidden="true">{{$cat->category->cat_name}}</i>
             </a>
                    ...
                    <div class="row">
                      <div class="col-sm-12 col-md-3">
                        <ul class="links list-unstyled">
                          @foreach($d as $d1)
                          <li><a href="#">{{$d1->sub_cat_name}}</a></li>
                          @endforeach
                        </ul>
                      </div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
              ...
              <div class="product-slider">
                ...
                <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="{{url('/product/product_details/'.$l->id)}}"><img src='{{asset("storage/".$l->prod_image)}}'>"</a> </div>
                          <!-- /.image -->
        ...
        <section class="section featured-product wow fadeInUp">
          ...
          <div class="row ">
            @foreach($all_prod_data as $all_d)
            <div class="col-md-3 item">
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> <a href="detail.html"><img  src='{{asset("storage/".$l->prod_image)}}' alt=""></a> </div>
                    <!-- /.image -->
                  ...
                  <div class="product-info text-left">
                    <h3 class="name"><a href="detail.html">{{$all_d->prod_title}}</a></h3>
                    <div class="rating rateit-small"></div>
                    <div class="description"></div>
                    <div class="product-price"> <span class="price">{{$all_d->prod_price}} </span>
        ...
        <!-- ============================================== WIDE PRODUCTS ============================================== -->
          ...
          <!-- ============================================== FEATURED PRODUCTS ============================================== -->
          <section class="section featured-product wow fadeInUp">
              <h3 class="section-title">Featured products 2</h3>
