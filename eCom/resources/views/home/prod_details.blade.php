                                ...
                                <div class="item">
                                    <div class="products">
                                        ...
                                        <div class="product-info text-left m-t-20">
                                            <h3 class="name"><a href="detail.html">{{$prod->prod_name}}</a></h3>
                        ...
                        <div class="row  wow fadeInUp">
                                        ...
                                        <div id="owl-single-product-thumbnails">
                                            <div class="item">
                                                <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide1">
                                                    <img class="img-responsive" width="85" alt="" src='{{asset("storage/".$prod->prod_image)}}' data-echo="assets/images/products/p17.jpg"/>
                                                </a>
                                            </div>
                            ...
                            <div class='col-sm-6 col-md-7 product-info-block'>
                                <div class="product-info">
                                    <h1 class="name">{{$prod->prod_name}}</h1>
                                    ...
                                    <div class="stock-container info-container m-t-10">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="stock-box">
                                                    <span class="value">{{$prod->prod_weight}}</span>
                                                </div>
                                            </div>
                                        </div><!-- /.row -->
                                    </div><!-- /.stock-container -->
                                    ...
                                    <div class="price-container info-container m-t-20">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="price-box">
                                                    <span class="price">{{$prod->prod_price}}</span>
