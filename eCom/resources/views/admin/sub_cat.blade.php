...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{asset('cat_asset/vendors/mdi/css/materialdesignicons.min.css')}}"
    />
    <link rel="stylesheet" href="{{asset('cat_asset/vendors/base/vendor.bundle.base.css')}}" />
    <!-- endinject -->
    <!-- plugin css for this page -->
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <link rel="stylesheet" href="{{asset('cat_asset/css/style.css')}}" />
    <!-- endinject -->
    <link rel="shortcut icon" href="{{asset('cat_asset/images/favicon.png')}}" />
  </head>
  ...
  <body>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{url('show_subcat')}}">
                <i class="mdi mdi-home menu-icon"></i>
                      ...
                      <table class="table">
                        ...
                        @if(isset($data))
                            ...
                            <tr>
                                ...
                                <td><a href = '{{url("cat_edit/".$d->id)}}'>Edit</a> <a href = '{{url("delete/".$d->id)}}'>Delete</a></td>
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="{{asset('cat_asset/vendors/base/vendor.bundle.base.js')}}"></script>
    <!-- endinject -->
    <!-- inject:js -->
    <script src="{{asset('cat_asset/js/off-canvas.js')}}"></script>
    <script src="{{asset('cat_asset/js/hoverable-collapse.js')}}"></script>
    <script src="{{asset('cat_asset/js/template.js')}}"></script>
    <!-- endinject -->
    <!-- Custom js for this page-->
    <script src="{{asset('cat_asset/js/file-upload.js')}}"></script>
